...
def train_and_test(net_class: torch.nn.Module,
    ...
    """
    Use all the default training sets as the training set, all the default test sets as the test set, use the optimal hyperparameters in the experimental results of the verification set to initialize the model, and perform acc evaluation

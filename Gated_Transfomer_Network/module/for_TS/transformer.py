...
class Transformer(torch.nn.Module):
    def __init__(self,
        ...
        self.timestep_embedding = Embedding(d_feature=d_feature, d_timestep=d_timestep, dropout=dropout,d_model=d_model, wise='timestep')
        self.feature_embedding = Embedding(d_feature=d_feature, d_timestep=d_timestep, dropout=dropout, d_model=d_model, wise='feature')

...
class PositionFeedforward(torch.nn.Module):
    def __init__(self,
        ...
        self.linear1 = torch.nn.Linear(in_features=d_model, out_features=d_hidden) #(512, 2048)
        self.linear2 = torch.nn.Linear(in_features=d_hidden, out_features=d_model) #(2048, 512)

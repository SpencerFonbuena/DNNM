...
from datasetprocess.datasetprocess import Create_Dataset
...
print(f'train data size: [{66_000, d_input, d_channel}]')
...
def train():
    ...
    result_visualization(loss_list=loss_list, correct_on_test=correct_on_test, correct_on_train=correct_on_train,
                         ...
                         d_model=d_model, q=q, v=v, h=h, N=N, dropout=dropout, BATCH_SIZE=BATCH_SIZE,
